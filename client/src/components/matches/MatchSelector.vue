<template>
  <VRow class="mb-1">
    <VCol>
      ...
      <VAlert
        v-if="!!matchStore.nextMatchError"
        color="error"
        variant="tonal"
        class="mb-2"
      >
      ...
      -->
      <VAutocomplete
        v-model="matchStore.selectedMatchKey"
        class="mt-6"
      ...
      <VBtn
        v-if="!settingsStore.settings?.useFrcEventsApi && matchStore.selectedMatchKey"
      ...
      <VAlert
        v-else-if="shouldShowNextMatchBtnUnavailableError"
        color="warning"
        variant="tonal"
        class="mt-2"
      >
